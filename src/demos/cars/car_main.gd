...
var ga = GeneticAlgorithm.new(23, [10, 5, 8], 4, agent_body_path, true, "car_params")
...
#			if is_instance_valid(ga.curr_best):
#				var network = ga.curr_best.agent.network
#				network.save_to_json("DisD_"+str(generation_step))
